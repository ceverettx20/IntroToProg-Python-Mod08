...
# Chris Everett, 3-7-2022,Modified code to complete assignment 8
# Ceverett, 3-8-2022, Finish modifying code to work in program
# ------------------------------------------------------------------------ #
...
class Product:
    ...
    changelog: (When,Who,What)
        ...
        CEverett, 3-7-2022,Modified code to complete assignment 8
    """
    # --Fields--
    # --Constructor--
